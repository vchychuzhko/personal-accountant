...
final class Version20240926043433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE deposit (id INT AUTO_INCREMENT NOT NULL, balance_id INT NOT NULL, name VARCHAR(255) NOT NULL, amount DOUBLE PRECISION NOT NULL, actual_profit DOUBLE PRECISION DEFAULT NULL, status INT NOT NULL, interest DOUBLE PRECISION NOT NULL, tax DOUBLE PRECISION DEFAULT NULL, period INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, INDEX IDX_95DB9D39AE91A3DD (balance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
