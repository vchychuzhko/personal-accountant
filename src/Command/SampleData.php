...
#[AsCommand(name: 'app:sample-data', description: 'Deploy sample data for demo store: Currencies, Balances, Tags, Incomes, Payments, Exchanges, Deposits, Loans.')]
class SampleData extends Command
{
    private const TABLES_TO_TRUNCATE = ['currency', 'balance', 'tag', 'income', 'payment', 'exchange', 'deposit', 'loan'];
    ...
    private const PAYMENT_SAMPLE_DATA = [
        ...
        ['balance_id' => 3, 'tag_id' => 3, 'name' => 'Parking', 'amount' => 100, 'created_at' => '3 months 2 days ago 07:35:00'],
        ...
        ['balance_id' => 3, 'tag_id' => 3, 'name' => 'Parking', 'amount' => 100, 'created_at' => '1 month 5 days ago 08:25:00'],
        ...
        ['balance_id' => 1, 'tag_id' => 3, 'name' => 'Parking', 'amount' => 100, 'created_at' => '5 days ago 07:45:00'],
